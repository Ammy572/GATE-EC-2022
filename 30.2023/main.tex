...
\begin{enumerate}
\item 
Plot for $S_X(w) = {\frac{2}{9+w^2}}$
\begin{figure}[ht!]
	\centering
	\includegraphics[width=\columnwidth]{/home/aman123/GATE-EC(2022)/30.2023/figs/plot.png}
    \caption{plot1}
	\label{Fig:Figure3}
\end{figure}
\begin{align}
...
S_X &= \begin{cases}
	...
	0, \text{otherwise}
\end{cases}\\
R_X(\tau) &= \frac{1}{2\pi}\int_{-\infty}^{\infty}{S_X e^{jw\tau}dw}\\
&= \frac{1}{2{\pi}{j}{\tau}}(e^{jw_0\tau}-1)
\end{align}
So, $R_X(\tau)$ is complex and cannot give a valid $S_X$\\
\end{enumerate} 
