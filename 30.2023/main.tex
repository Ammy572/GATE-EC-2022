...
\item See \figref{Fig:Figure1}\label{eq:30/2023/3}
\begin{figure}[ht]
	\centering
	...
	\label{Fig:Figure1}
\end{figure}
\item See \figref{Fig:Figure2}\label{eq:30/2023/4}
\begin{figure}[ht!]
	\centering
...
\begin{align}
Im(s_X(\omega)) &=-\int{j\sbrak{R_X(\tau)sin(\omega\tau)d\tau}} \\
&= 0\\
\text{and, }
s_X(-\omega)&=s_X(\omega)\\
...
So, $S_X$ is valid.\\
\item
Refer to the properties in \eqref{eq:30/2023/3} \& \eqref{eq:30/2023/4}
\begin{align}
Im(e^{-\omega^2}cos^2\omega)=0\\
